...
def encr(request):
    ...
    try:
        ...
        kk1,kk2,kk3,kk4,kkk,pt_d,time = decryption(ct,key)
        pt2=""
        ...
        for i in range(0,len(ct),2):
            ct2=ct2+ct[i:i+2]+" "
        return render(request, "encryption.html", {"display" : "inline-block", "pt": pt2, "key2":key2, "kk1":kk1, "kk2":kk2, "kk3":kk3, "kk4":kk4, "kkk":kkk, "ct2":ct2, "ptd":pt_d, "time":time})
        # res= encryption()
